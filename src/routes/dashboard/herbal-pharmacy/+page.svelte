...
<svelte:head>
	<title>{m.dashboard_herbal_pharmacy_meta_title()}</title>
	<meta name="description" content={m.database_project_herbal_pharmacy_description()} />
</svelte:head>
...
<section class="dashboard-detail">
	<div class="dashboard-detail__wrap">
		...
		<header class="dashboard-detail__header">
			<div class="dashboard-detail__header-copy">
				...
				<p class="dashboard-detail__description">
					{m.database_project_herbal_pharmacy_description()}
				</p>
			</div>

			<img
				class="dashboard-detail__image"
				src={herbalPharmacyImage}
				alt={m.home_database_herbal_pharmacy_image_alt()}
			/>
		</header>
		...
		<div class="dashboard-detail__pathway">
			{#each herbalPharmacyPathway as phase, index (phase.name)}
